...
LOG_DIR1 = 'D:/Downloads/logs/atari_vanilla' + str(LR)
LOG_INTERVAL = 1000
...
if __name__ == '__main__':
    ...
    # summary_writer1 = SummaryWriter(LOG_DIR1)
    ...
    # online_net.load('D:/Downloads/starter_code_double_dqn/model.pack')
    ...
    obses = env.reset()
    for ik in range(MIN_REPLAY_SIZE):
    ...
    for step in itertools.count():
        ...
        if step % LOG_INTERVAL == 0:
            ...
            # summary_writer1.add_scalar('AvgRew', rew_mean, global_step=step)
            # summary_writer1.add_scalar('AvgEpLen', len_mean, global_step=step)
            # summary_writer1.add_scalar('Episodes', episode_count, global_step=step)
